...
{
    /// <summary>
    /// Tests whether a DownloadManifest can get destroy successfully
    /// </summary>
    class DestroyTest01<T> : Test<T> where T : IDownloadEngine, new()
    {
        public DestroyTest01(Tests<T> parent) : base(parent) { }
